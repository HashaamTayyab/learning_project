...
class Dot(models.Model):
    track = models.ForeignKey(Track, related_name='dots', on_delete=models.CASCADE)
    name = models.CharField(max_length=255)

class SubDot(models.Model):
    dot = models.ForeignKey(Dot, related_name='subdots', on_delete=models.CASCADE)
    name = models.CharField(max_length=255)
...
class Editor(AbstractUser):
    subscribed_dots = models.ManyToManyField(Dot, blank=True)
