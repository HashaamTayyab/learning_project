...
from .views import editor_dashboard, view_modules, view_subdots, view_topics, view_topic, subscribe_editor, add_topic, content_addition, add_subdot, login_view

urlpatterns = [
    path('', editor_dashboard, name='editor_dashboard'),
    path('modules/<int:track_id>/', view_modules, name='view_modules'),
    path('subdots/<int:module_id>/', view_subdots, name='view_subdots'),
    ...
    path('add_subdot/<int:module_id>/', add_subdot, name='add_subdot'),  # New URL for adding subdots
